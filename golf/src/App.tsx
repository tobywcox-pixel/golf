...
export default function App() {
  ...
  useEffect(() => {
    const pageTitles: { [key: number]: string } = {
      0: "Home | Golf Studios | Web Design South of England",
      1: "About | Hampshire Web Design Studio",
      2: "Portfolio | Our Work | Golf Studios",
      3: "Web Design | Services | Golf Studios",
      4: "App Design | Services | Golf Studios",
      5: "SEO & Optimisation | Services | Golf Studios",
      6: "Branding | Services | Golf Studios",
      7: isMobile ? "Start a Project | Contact Form" : "Contact | Start a Project | South of England",
      8: "Contact Info | Golf Studios"
    };
    
    document.title = pageTitles[currentPage] || "Golf Studios | Web Design South of England";
  }, [currentPage]);
