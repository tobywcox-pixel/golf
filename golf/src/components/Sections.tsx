      ...
      >
        <div className="max-w-5xl">
          ...
          <div className="sr-only">
            ...
            <p>
              Golf Studios specializes in bespoke web design, high-performance web development, and strategic branding for businesses in Southampton, Portsmouth, Winchester, and across the South of England. Our Hampshire-based digital agency creates design-led experiences that convert and perform.
            </p>
            <ul>
